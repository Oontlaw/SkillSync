...
def test_dashboard_v2_csrf_protection(client):
    ...
    response = client.post('/v2/ml/anomaly-feedback', 
                          json={'anomaly_id': '1', 'feedback': 'confirmed'})
...
def test_dashboard_v2_ml_endpoints_exist(client, auth_headers):
    ...
    for endpoint, method in endpoints:
        ...
        assert response.status_code == 200, f"Endpoint {endpoint} failed: {response.data}"
